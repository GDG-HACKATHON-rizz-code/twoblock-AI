...
export const INITIAL_CLASSMATES: DemoStudentProfile[] = [
  ...
  },
  {
    ...
    activities: ['Music', 'Problem solving'],
    is_demo: true,
    is_demo_account: true,
    profile_completed: true,
    diagnostic_completed: true,
  ...
  },
  {
    ...
    favouriteSubject: 'Science',
    preferredStudyTime: '7:00 PM',
    activities: ['Science experiments'],
    is_demo: true,
    is_demo_account: true,
    profile_completed: true,
    diagnostic_completed: true,
  ...
  },
  {
    ...
    favouriteSubject: 'English',
    preferredStudyTime: '7:00 PM',
    activities: ['Reading', 'Creative work'],
    is_demo: true,
    is_demo_account: true,
    profile_completed: true,
    diagnostic_completed: true,
  ...
  },
  {
    ...
    },
    {
      ...
      activities: ['Science experiments', 'Reading'],
      is_demo: true,
      is_demo_account: true,
      profile_completed: true,
      diagnostic_completed: true,
...
class DemoDataService {
  ...
  public getTeacherStudents(filter: string = 'all') {
    ...
    return {
      ...
      counts: {
        good: all.filter(s => s.healthScore >= 75).length,
